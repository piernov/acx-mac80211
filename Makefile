...
ifndef COMPAT_WIRELESS
	$(MAKE) -C $(KERNELDIR) M=$(PWD) $(EXTRA_KCONFIG) KCFLAGS="$(EXTRA_CFLAGS)" EXTRA_CFLAGS="$(EXTRA_CFLAGS) -DACX_GIT_VERSION=\\\"$(ACX_GIT_VERSION)\\\"" modules
else
	$(MAKE) -C $(KERNELDIR) M=$(PWD) $(EXTRA_KCONFIG) KCFLAGS="$(EXTRA_CFLAGS)" EXTRA_CFLAGS="$(EXTRA_CFLAGS) -DACX_GIT_VERSION=\\\"$(ACX_GIT_VERSION)\\\"" \
